...
#include "src/syntacticSugar.h" // type definitions, global functions, etc.
#include "src/config.h"         // pin numbers, mappings, etc.
#include "src/hardware.h"       // background drivers for rotary / key input and audio output
...
#include "src/LEGACYlayout.h"
#include "src/LEGACYcolor.h"
